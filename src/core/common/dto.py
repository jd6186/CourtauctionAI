...
from ..code.error_type_code import EXCEPTION_TYPE
...
class ResponseDTO(BaseModel):
    ...
    def of_by_exception_type(self, exception_type: EXCEPTION_TYPE):
        self.result_data = exception_type.value["message"]
        self.timestamp = core_util.get_seoul_datetime_format()
        self.status_code = exception_type.value["code"]
        self.status_message = exception_type.value["message"]
        return JSONResponse(content=self.dict())
