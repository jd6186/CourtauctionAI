...
class EXCEPTION_TYPE(Enum):
    ...
    ERROR_2001 = {"code": "2001", "message": "사용 가능한 이메일입니다."}
    ERROR_2002 = {"code": "2002", "message": "이미 가입한 이메일입니다. 다시 확인해주세요."}
    ERROR_2003 = {"code": "2003", "message": "이메일 발송에 성공했습니다. 이메일을 확인해주세요."}
    ERROR_2004 = {"code": "2004", "message": "이메일 발송에 실패했습니다."}
    ERROR_2005 = {"code": "2005", "message": "사용 가능한 닉네임입니다."}
    ERROR_2006 = {"code": "2006", "message": "이미 사용중인 닉네임입니다."}
    ...
    ERROR_506 = {"code": "506", "message": "DATABASE_BAD_REQUEST"}
    ERROR_507 = {"code": "507", "message": "AWS_S3_UPLOAD_ERROR"}
    ERROR_508 = {"code": "508", "message": "FILE_OVER_SIZE"}
    ERROR_509 = {"code": "509", "message": "FILE_TYPE_ERROR"}
    ...
    def raise_exception(exception_type):
        raise HTTPException(status_code=exception_type.value["code"], detail=exception_type.value["message"])
